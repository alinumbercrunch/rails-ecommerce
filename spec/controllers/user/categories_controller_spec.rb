...
RSpec.describe User::CategoriesController, type: :controller do
  ...
  # User::Category. As you add validations to User::Category, be sure to
  ...
  # User::CategoriesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "renders a response with 422 status (i.e. to display the 'new' template)" do
        post :create, params: {user_category: invalid_attributes}, session: valid_session
